    ...
    companion object{
        ...
        fun loadThumbnails(context : Context) : ArrayList<Thumbnail>{
            ...
            File(sourcePath).listFiles().forEach {
                ...
                val thumbnailPath = getThumbnailPath(context) + "/${thumbnailName}.png"
        ...
        fun saveImage(imageBitmap : Bitmap, context: Context) : Thumbnail{
            ...
            val thumbnailPath = getThumbnailPath(context) + "/${kotlin.math.abs(imageBitmap.hashCode())}${sourceName}.png"
